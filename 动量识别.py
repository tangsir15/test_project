...
data = calculate_and_normalize_momentum(data, 'LastPrice', window,normalized_window)
...
print(data[['LastPrice', 'Normalized_LastPrice_Momentum', 'Volume', 'Normalized_Volume_Momentum', 'Bid_Ask_Volume_Ratio_diff', 'Normalized_Bid_Ask_Volume_Ratio_diff_Momentum','OpenInterest','Normalized_OpenInterest_Momentum']].tail())




data['Composite_Momentum']=data['Normalized_LastPrice_Momentum']*0.2+data['Normalized_Volume_Momentum']*0.3+data['Normalized_Bid_Ask_Volume_Ratio_diff_Momentum']*0.3+data['Normalized_Volume_Momentum']*0.4
print(data[['LastPrice', 'Composite_Momentum']].tail())
